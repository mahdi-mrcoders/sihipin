          ...
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              return _this.axios.get("/api/pengguna/".concat(_this.uuid)).then(function (response) {
                ...
                var _console;
                /* eslint-disable */(_console = console).log.apply(_console, _toConsumableArray(oo_oo("2017188033_139_16_139_34_4", error)));
              });
            case 2:
            case "end":
          ...
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              ...
              return _this2.axios.get("/api/dosen/byemail/".concat(email)).then(function (responses) {
                ...
                var _console2;
                /* eslint-disable */(_console2 = console).log.apply(_console2, _toConsumableArray(oo_oo("2017188033_148_16_148_34_4", error)));
              });
            case 2:
            case "end":
          ...
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              ...
              return _this3.axios.get("/api/penelitian?level=".concat(_this3.level, "&idsn=").concat(_this3.idsn)).then(function (response) {
                ...
                var _console3;
                /* eslint-disable */(_console3 = console).log.apply(_console3, _toConsumableArray(oo_oo("2017188033_156_20_156_38_4", error)));
              });
            case 3:
              _context3.next = 7;
              break;
          ...
          while (1) switch (_context4.prev = _context4.next) {
            ...
            case 3:
              ...
              docx.renderAsync(blob, container, null, docxOptions).then(function (x) {
                var _console4;
                /* eslint-disable */(_console4 = console).log.apply(_console4, _toConsumableArray(oo_oo("2017188033_183_24_183_38_4", x)));
              });
