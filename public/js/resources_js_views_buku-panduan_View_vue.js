  ...
  methods: {
    ...
    create: function create() {
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
        var formData, _console, response, _console2, _response, _console3;
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              ...
              /* eslint-disable */(_console = console).log.apply(_console, _toConsumableArray(oo_oo("571068333_131_16_131_38_4", _this3.file)));
              if (_this3.blob) {
                _context3.next = 9;
                break;
              }
            ...
            case 11:
              ...
              if (response.status == 200) {
                ...
                /* eslint-disable */(_console2 = console).log.apply(_console2, _toConsumableArray(oo_oo("571068333_155_24_155_45_4", response)));
              }
            case 13:
              _context3.next = 20;
              break;
            ...
            case 18:
              ...
              if (_response.status == 200) {
                ...
                /* eslint-disable */(_console3 = console).log.apply(_console3, _toConsumableArray(oo_oo("571068333_177_20_177_41_4", _response)));
              }
            case 20:
            case "end":
