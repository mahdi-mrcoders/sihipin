            ...
            case 0:
              ...
              return _this3.axios.get("/api/pengguna/".concat(localStorage.getItem('uuid'))).then(function (response) {
                _this3.axios.get("/api/dosen/byemail/".concat(response.data.email_dosen)).then(function (data) {
                  ...
                  var _console;
                  /* eslint-disable */(_console = console).log.apply(_console, _toConsumableArray(oo_oo("1635721944_354_20_354_38_4", error)));
                });
              })["catch"](function (error) {
                var _console2;
                /* eslint-disable */(_console2 = console).log.apply(_console2, _toConsumableArray(oo_oo("1635721944_357_16_357_34_4", error)));
              });
            case 2:
            case "end":
          ...
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              ...
              return _this4.axios.get("/api/penelitian/".concat(_this4.$route.params.id)).then(function (response) {
                ...
                var _console3;
                /* eslint-disable */(_console3 = console).log.apply(_console3, _toConsumableArray(oo_oo("1635721944_367_16_367_34_4", error)));
              });
            case 2:
            case "end":
          ...
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              ...
              return _this5.axios.get("/api/datapenilaian?idp=".concat(_this5.$route.params.id, "&idsn=").concat(_this5.userReviewer.id)).then(function (response) {
                ...
                var _console4;
                /* eslint-disable */(_console4 = console).log.apply(_console4, _toConsumableArray(oo_oo("1635721944_396_16_396_34_4", error)));
              });
            case 2:
            case "end":
    ...
    submitPenilaian: function submitPenilaian() {
      ...
      this.$swal({
        ...
        if (!result.isDismissed) {
          ...
          /* eslint-disable */
          (_console5 = console).log.apply(_console5, _toConsumableArray(oo_oo("1635721944_434_20_434_51_4", _this6.submitedNilai)));
          if (_this6.stateSubmit) {
            _this6.axios.post('/api/datapenilaian', _this6.submitedNilai).then(function (response) {
              ...
              var _console6;
              /* eslint-disable */(_console6 = console).log.apply(_console6, _toConsumableArray(oo_oo("1635721944_445_28_445_46_4", error)));
            });
          } else {
            _this6.axios.post("/api/datapenilaian/".concat(_this6.$route.params.id), _this6.submitedNilai).then(function (response) {
              var _console7;
              /* eslint-disable */(_console7 = console).log.apply(_console7, _toConsumableArray(oo_oo("1635721944_449_28_449_54_4", response.data)));
              // this.$swal({
              //     title: "Success",
              //     text: "Penilaian Berhasil Dilakukan Anda Akan dikembalikan Helaman Sebelumnya",
              //     icon: "success"
              ...
              var _console8;
              /* eslint-disable */(_console8 = console).log.apply(_console8, _toConsumableArray(oo_oo("1635721944_458_28_458_46_4", error)));
            });
          }
        }
      });
