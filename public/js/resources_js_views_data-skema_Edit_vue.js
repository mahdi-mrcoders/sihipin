          ...
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              return _this.axios.get('/api/datajabfung').then(function (response) {
                ...
                var _console;
                /* eslint-disable */(_console = console).log.apply(_console, _toConsumableArray(oo_oo("3776157007_145_16_145_34_4", error)));
              });
            case 2:
            case "end":
          ...
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              ...
              return _this2.axios.get("/api/dataskema/".concat(_this2.$route.params.id)).then(function (response) {
                ...
                var _console2;
                /* eslint-disable */(_console2 = console).log.apply(_console2, _toConsumableArray(oo_oo("3776157007_166_16_166_34_4", error)));
              });
            case 2:
            case "end":
          ...
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              _this3.axios.post("/api/dataskema/".concat(_this3.$route.params.id), _this3.dataForm).then(function (response) {
                ...
                var _console3;
                /* eslint-disable */(_console3 = console).log.apply(_console3, _toConsumableArray(oo_oo("3776157007_181_16_181_34_4", error)));
              });
            case 1:
            case "end":
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  }, null, 512 /* NEED_PATCH */), [[vue__WEBPACK_IMPORTED_MODULE_0__.vModelRadio, $data.dataForm.program_skema]]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)(" Program Penelitian "), _hoisted_32])])])])]), _hoisted_33, (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_34, [_hoisted_35, (0,vue__WEBPACK_IMPORTED_MODULE_0__.withDirectives)((0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("select", {
    name: "",
    id: "",
    "class": "form-control",
    required: "",
    "onUpdate:modelValue": _cache[6] || (_cache[6] = function ($event) {
      return $data.dataForm.ketua_jabfung = $event;
    })
  }, [_hoisted_36, ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($data.listData, function (jabfung) {
