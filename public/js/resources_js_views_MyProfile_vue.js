  ...
  methods: {
          ...
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              return _this.axios.get("/api/pengguna/".concat(_this.uuid)).then(function (response) {
                ...
                var _console;
                /* eslint-disable */(_console = console).log.apply(_console, _toConsumableArray(oo_oo("1446909018_91_16_91_34_4", error)));
              });
            case 2:
            case "end":
          ...
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              ...
              return _this2.axios.get("/api/dosen/byemail/".concat(email)).then(function (responses) {
                ...
                var _console2;
                /* eslint-disable */(_console2 = console).log.apply(_console2, _toConsumableArray(oo_oo("1446909018_103_16_103_34_4", error)));
              });
            case 2:
            case "end":
    ...
    setJabfung: function setJabfung(jabfung) {
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
        var _console3, response, optionJabfung, _yield$_this4$$swal, fruit;
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            ...
            case 3:
              ...
              optionJabfung = {};
              /* eslint-disable */
              (_console3 = console).log.apply(_console3, _toConsumableArray(oo_oo("1446909018_134_16_134_42_4", response.data)));
    ...
    setGolPang: function setGolPang(golpang) {
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5() {
        var _console4, response, optiongolpang, _yield$_this5$$swal, fruit;
        return _regeneratorRuntime().wrap(function _callee5$(_context5) {
          while (1) switch (_context5.prev = _context5.next) {
            ...
            case 3:
              ...
              optiongolpang = {};
              /* eslint-disable */
              (_console4 = console).log.apply(_console4, _toConsumableArray(oo_oo("1446909018_163_16_163_42_4", response.data)));
              response.data.forEach(function (item) {
            ...
            case 9:
              ...
              if (fruit) {
                _this5.profile.golongan_pangkat = fruit;
              }
              _context5.next = 16;
              break;
            case 14:
          ...
          while (1) switch (_context6.prev = _context6.next) {
            case 0:
              ...
              _this6.axios.post("/api/datadosen/".concat(_this6.profile.id), _this6.profile).then(function (response) {
                ...
                var _console5;
                /* eslint-disable */(_console5 = console).log.apply(_console5, _toConsumableArray(oo_oo("1446909018_200_16_200_34_4", error)));
              });
            case 2:
            case "end":
    ...
    changeFoto: function changeFoto() {
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7() {
        var _yield$_this7$$swal, file, _console6, reader;
        return _regeneratorRuntime().wrap(function _callee7$(_context7) {
          while (1) switch (_context7.prev = _context7.next) {
            ...
            case 2:
              ...
              if (file) {
                /* eslint-disable */(_console6 = console).log.apply(_console6, _toConsumableArray(oo_oo("1446909018_219_16_219_33_4", file)));
