  ...
  methods: {
          ...
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              return _this.axios.get("/api/pengguna/".concat(_this.uuid)).then(function (response) {
                ...
                var _console;
                /* eslint-disable */(_console = console).log.apply(_console, _toConsumableArray(oo_oo("1824243060_91_16_91_34_4", error)));
              });
            case 2:
            case "end":
          ...
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              ...
              return _this2.axios.get("/api/dosen/byemail/".concat(email)).then(function (responses) {
                ...
                var _console2;
                /* eslint-disable */(_console2 = console).log.apply(_console2, _toConsumableArray(oo_oo("1824243060_103_16_103_34_4", error)));
              });
            case 2:
            case "end":
          ...
          while (1) switch (_context6.prev = _context6.next) {
            case 0:
              ...
              _this6.axios.post("/api/datadosen/".concat(_this6.profile.id), _this6.profile).then(function (response) {
                ...
                var _console3;
                /* eslint-disable */(_console3 = console).log.apply(_console3, _toConsumableArray(oo_oo("1824243060_199_16_199_34_4", error)));
              });
            case 2:
            case "end":
    ...
    changeFoto: function changeFoto() {
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7() {
        var _yield$_this7$$swal, file, _console4, reader;
        return _regeneratorRuntime().wrap(function _callee7$(_context7) {
          while (1) switch (_context7.prev = _context7.next) {
            ...
            case 2:
              ...
              if (file) {
                /* eslint-disable */(_console4 = console).log.apply(_console4, _toConsumableArray(oo_oo("1824243060_218_16_218_33_4", file)));
