...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  created: function created() {
    ...
    this.axios.get("/api/dataperiode?aktif=Y").then(function (response) {
      ...
      var _console;
      /* eslint-disable */(_console = console).log.apply(_console, _toConsumableArray(oo_oo("1621569980_237_12_237_30_4", error)));
    });
  },
  methods: {
          ...
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              return _this2.axios.get("/api/pengguna/".concat(_this2.uuid)).then(function (response) {
                ...
                var _console2;
                /* eslint-disable */(_console2 = console).log.apply(_console2, _toConsumableArray(oo_oo("1621569980_252_16_252_34_4", error)));
              });
            case 2:
            case "end":
          ...
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              ...
              return _this3.axios.get("/api/dosen/byemail/".concat(email)).then(function (responses) {
                ...
                var _console3;
                /* eslint-disable */(_console3 = console).log.apply(_console3, _toConsumableArray(oo_oo("1621569980_262_16_262_34_4", error)));
              });
            case 2:
            case "end":
          ...
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              ...
              return _this4.axios.get("/api/penelitian?level=".concat(_this4.level, "&idsn=").concat(_this4.idsn)).then(function (response) {
                ...
                var _console4;
                /* eslint-disable */(_console4 = console).log.apply(_console4, _toConsumableArray(oo_oo("1621569980_270_20_270_38_4", error)));
              });
            case 3:
              _context3.next = 7;
              break;
          ...
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              ...
              return _this5.axios.get('/api/dataskema').then(function (response) {
                ...
                var _console5;
                /* eslint-disable */(_console5 = console).log.apply(_console5, _toConsumableArray(oo_oo("1621569980_281_16_281_34_4", error)));
              });
            case 2:
            case "end":
          ...
          while (1) switch (_context7.prev = _context7.next) {
            ...
            case 15:
              ...
              return _this8.axios.post('/api/createkontrak', _this8.dataKontrak).then(function (response) {
                ...
                _this8.getDataUser();
                /* eslint-disable */
                (_console6 = console).log.apply(_console6, _toConsumableArray(oo_oo("1621569980_484_32_484_58_4", response.data)));
              })["catch"](function (error) {
                var _console7;
                /* eslint-disable */(_console7 = console).log.apply(_console7, _toConsumableArray(oo_oo("1621569980_486_32_486_50_4", error)));
              });
            case 23:
            case "end":
          ...
          while (1) switch (_context8.prev = _context8.next) {
            ...
            case 2:
              ...
              return _this9.axios.post('/api/uploadprogress', formData, {
                ...
                var _console8;
                /* eslint-disable */(_console8 = console).log.apply(_console8, _toConsumableArray(oo_oo("1621569980_612_20_612_46_4", response.data)));
                _this9.getDataUser();
              })["catch"](function (error) {
                console.log();
              });
          ...
          while (1) switch (_context9.prev = _context9.next) {
            ...
            case 2:
              ...
              return _this10.axios.post('/api/uploadppt/' + id, formData, {
                ...
                var _console9;
                /* eslint-disable */(_console9 = console).log.apply(_console9, _toConsumableArray(oo_oo("1621569980_646_20_646_46_4", response.data)));
                _this10.getDataUser();
              })["catch"](function (error) {
                console.log();
              });
          ...
          while (1) switch (_context10.prev = _context10.next) {
            ...
            case 5:
              ...
              docx.renderAsync(blob, container, null, docxOptions).then(function (x) {
                var _console10;
                /* eslint-disable */(_console10 = console).log.apply(_console10, _toConsumableArray(oo_oo("1621569980_669_28_669_42_4", x)));
              });
    ...
    getFileExtension: function getFileExtension(filename) {
      ...
      /* eslint-disable */
      (_console11 = console).log.apply(_console11, _toConsumableArray(oo_oo("1621569980_704_12_704_28_4", ext)));
      if (ext == 'docx') {
        return 'fa-file-word';
      } else if (ext == 'pdf') {
        return 'fa-file-pdf';
