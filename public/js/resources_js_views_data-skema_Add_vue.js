          ...
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              return _this.axios.get('/api/datajabfung').then(function (response) {
                ...
                var _console;
                /* eslint-disable */(_console = console).log.apply(_console, _toConsumableArray(oo_oo("770457120_128_16_128_34_4", error)));
              });
            case 2:
            case "end":
          ...
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              _this2.axios.post('/api/dataskema', _this2.dataForm).then(function (response) {
                ...
                var _console2;
                /* eslint-disable */(_console2 = console).log.apply(_console2, _toConsumableArray(oo_oo("770457120_143_16_143_34_4", error)));
              });
            case 1:
            case "end":
