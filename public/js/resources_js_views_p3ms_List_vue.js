          ...
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              return _this.axios.get("/api/pengguna/".concat(_this.uuid)).then(function (response) {
                ...
                var _console;
                /* eslint-disable */(_console = console).log.apply(_console, _toConsumableArray(oo_oo("1608811935_146_16_146_34_4", error)));
              });
            case 2:
            case "end":
              return _context.stop();
          ...
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              ...
              return _this2.axios.get("/api/dosen/byemail/".concat(email)).then(function (responses) {
                ...
                var _console2;
                /* eslint-disable */(_console2 = console).log.apply(_console2, _toConsumableArray(oo_oo("1608811935_155_16_155_34_4", error)));
              });
            case 2:
            case "end":
              return _context2.stop();
          ...
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              ...
              return _this3.axios.get("/api/penelitian?level=".concat(_this3.level, "&idsn=").concat(_this3.idsn)).then(function (response) {
                ...
                var _console3;
                /* eslint-disable */(_console3 = console).log.apply(_console3, _toConsumableArray(oo_oo("1608811935_167_16_167_34_4", error)));
              });
            case 2:
            case "end":
              return _context3.stop();
          ...
          while (1) switch (_context4.prev = _context4.next) {
            ...
            case 9:
              ...
              return _this4.axios.post("/api/validasiprogress/".concat(id), dataProgress).then(function (response) {
                ...
                var _console4;
                /* eslint-disable */(_console4 = console).log.apply(_console4, _toConsumableArray(oo_oo("1608811935_241_24_241_42_4", error)));
              });
            case 15:
              _context4.next = 25;
              break;
            ...
            case 19:
              ...
              return _this4.axios.post("/api/validasiprogress/".concat(id), _dataProgress).then(function (response) {
                ...
                var _console5;
                /* eslint-disable */(_console5 = console).log.apply(_console5, _toConsumableArray(oo_oo("1608811935_263_28_263_46_4", error)));
              });
            case 25:
            case "end":
              return _context4.stop();
