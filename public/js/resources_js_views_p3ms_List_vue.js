          ...
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              return _this.axios.get("/api/pengguna/".concat(_this.uuid)).then(function (response) {
                ...
                var _console;
                /* eslint-disable */(_console = console).log.apply(_console, _toConsumableArray(oo_oo("29712552_103_16_103_34_4", error)));
              });
            case 2:
            case "end":
              return _context.stop();
          ...
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              ...
              return _this2.axios.get("/api/dosen/byemail/".concat(email)).then(function (responses) {
                ...
                var _console2;
                /* eslint-disable */(_console2 = console).log.apply(_console2, _toConsumableArray(oo_oo("29712552_112_16_112_34_4", error)));
              });
            case 2:
            case "end":
              return _context2.stop();
          ...
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              ...
              return _this3.axios.get("/api/penelitian?level=".concat(_this3.level, "&idsn=").concat(_this3.idsn)).then(function (response) {
                ...
                var _console3;
                /* eslint-disable */(_console3 = console).log.apply(_console3, _toConsumableArray(oo_oo("29712552_119_16_119_34_4", error)));
              });
            case 2:
            case "end":
              return _context3.stop();
          ...
          while (1) switch (_context4.prev = _context4.next) {
            ...
            case 3:
              ...
              docx.renderAsync(blob, container, null, docxOptions).then(function (x) {
                var _console4;
                /* eslint-disable */(_console4 = console).log.apply(_console4, _toConsumableArray(oo_oo("29712552_140_24_140_38_4", x)));
              });
          ...
          while (1) switch (_context6.prev = _context6.next) {
            ...
            case 4:
              ...
              return _this6.axios.post('/api/updatevalidasi', _this6.dataPengajuan).then(function (response) {
                ...
                var _console5;
                /* eslint-disable */(_console5 = console).log.apply(_console5, _toConsumableArray(oo_oo("29712552_198_20_198_38_4", error)));
              });
            case 11:
            case "end":
              return _context6.stop();
