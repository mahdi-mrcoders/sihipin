          ...
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              return _this.axios.get("/api/pengguna/".concat(_this.uuid)).then(function (response) {
                ...
                var _console;
                /* eslint-disable */(_console = console).log.apply(_console, _toConsumableArray(oo_oo("4023926810_99_16_99_34_4", error)));
              });
            case 2:
            case "end":
              return _context.stop();
          ...
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              ...
              return _this2.axios.get("/api/dosen/byemail/".concat(email)).then(function (responses) {
                ...
                var _console2;
                /* eslint-disable */(_console2 = console).log.apply(_console2, _toConsumableArray(oo_oo("4023926810_108_16_108_34_4", error)));
              });
            case 2:
            case "end":
              return _context2.stop();
          ...
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              ...
              return _this3.axios.get("/api/penelitian?level=".concat(_this3.level, "&idsn=").concat(_this3.idsn)).then(function (response) {
                ...
                var _console3;
                /* eslint-disable */(_console3 = console).log.apply(_console3, _toConsumableArray(oo_oo("4023926810_115_16_115_34_4", error)));
              });
            case 2:
            case "end":
              return _context3.stop();
          ...
          while (1) switch (_context4.prev = _context4.next) {
            ...
            case 3:
              ...
              docx.renderAsync(blob, container, null, docxOptions).then(function (x) {
                var _console4;
                /* eslint-disable */(_console4 = console).log.apply(_console4, _toConsumableArray(oo_oo("4023926810_136_24_136_38_4", x)));
              });
          ...
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              ...
              return _this3.axios.get("/api/pengguna/".concat(_this3.uuid)).then(function (response) {
                ...
                var _console;
                /* eslint-disable */(_console = console).log.apply(_console, _toConsumableArray(oo_oo("3669070069_163_16_163_34_4", error)));
              });
            case 2:
            case "end":
              return _context2.stop();
          ...
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              ...
              return _this4.axios.get("/api/dosen/byemail/".concat(email)).then(function (responses) {
                ...
                var _console2;
                /* eslint-disable */(_console2 = console).log.apply(_console2, _toConsumableArray(oo_oo("3669070069_172_16_172_34_4", error)));
              });
            case 2:
            case "end":
              return _context3.stop();
          ...
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              ...
              return _this5.axios.get("/api/penelitian?level=".concat(_this5.level, "&idsn=").concat(_this5.idsn)).then(function (response) {
                ...
                var _console3;
                /* eslint-disable */(_console3 = console).log.apply(_console3, _toConsumableArray(oo_oo("3669070069_180_16_180_34_4", error)));
              });
            case 2:
            case "end":
              return _context4.stop();
          ...
          while (1) switch (_context5.prev = _context5.next) {
            ...
            case 8:
              ...
              return _this6.axios.post('/api/updatevalidasi', _this6.dataPengajuan).then(function (response) {
                ...
                var _console4;
                /* eslint-disable */(_console4 = console).log.apply(_console4, _toConsumableArray(oo_oo("3669070069_246_24_246_42_4", error)));
              });
            case 15:
            case "end":
              return _context5.stop();
          ...
          while (1) switch (_context6.prev = _context6.next) {
            ...
            case 8:
              ...
              return _this7.axios.post('/api/updatevalidasipemenang', _this7.dataPengajuan).then(function (response) {
                ...
                var _console5;
                /* eslint-disable */(_console5 = console).log.apply(_console5, _toConsumableArray(oo_oo("3669070069_298_24_298_42_4", error)));
              });
            case 15:
            case "end":
              return _context6.stop();
          ...
          while (1) switch (_context7.prev = _context7.next) {
            ...
            case 7:
              ...
              return _this8.axios.post('/api/createkontrak', _this8.dataKontrak).then(function (response) {
                ...
                _this8.getDataUser();
                /* eslint-disable */
                (_console6 = console).log.apply(_console6, _toConsumableArray(oo_oo("3669070069_339_24_339_50_4", response.data)));
              })["catch"](function (error) {
                var _console7;
                /* eslint-disable */(_console7 = console).log.apply(_console7, _toConsumableArray(oo_oo("3669070069_341_24_341_42_4", error)));
              });
            case 15:
            case "end":
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_1, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("table", _hoisted_2, [_hoisted_3, $data.dataTable.length > 0 ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("tbody", _hoisted_4, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($data.dataTable, function (list, index) {
    ...
    }, "Atur Reviewer", 8 /* PROPS */, _hoisted_9)])]);
  }), 128 /* KEYED_FRAGMENT */))])) : ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("tbody", _hoisted_10, [].concat(_hoisted_12)))])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_FormModalReviewer, {
    dataPenelitian: $data.datatPenelitian,
    onStateResult: _cache[0] || (_cache[0] = function ($event) {
      return $options.ResultState($event);
    })
  }, null, 8 /* PROPS */, ["dataPenelitian"]), _hoisted_13], 64 /* STABLE_FRAGMENT */);
}
