                        ...
                        <form class="forms-sample" @submit.prevent="update">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control border border-secondary" v-model="dataForm.prodi"
                                    ...
                                    <option v-for="prodi in dataProdi" :key="prodi.kode_prodi" :value="prodi.singkatan">{{
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" v-model="dataForm.no_hp" :required="true">
                            </div>
                            <div class="form-group">
...
export default {
    ...
    methods: {
        ...
        async getDataDosen() {
            await this.axios.get(`/api/datadosen/${this.$route.params.id}`).then(response => {
                const { nrp, nidn, nama, no_hp, prodi, jabatan_fungsional, pangkat_golongan, email } = response.data
                this.dataForm.nrp = nrp
                this.dataForm.nidn = nidn
                this.dataForm.nama = nama
                this.dataForm.no_hp = no_hp
                this.dataForm.prodi = prodi
                this.dataForm.jabatan_fungsional = jabatan_fungsional
                this.dataForm.pangkat_golongan = pangkat_golongan
        ...
        async update() {
            this.axios.post(`/api/datadosen/${this.$route.params.id}`, this.dataForm).then(response => {
                this.$swal({
                    position: "top-end",
                    icon: "success",
