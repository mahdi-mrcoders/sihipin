...
export default {
    ...
    methods: {
        ...
        async tambahData() {
            ...
            if (name) {
                await this.axios.post('/api/datajabfung', { nama_jabfung: name }).then(response => {
                    this.$swal({
                        position: "top-end",
                        icon: "success",
       ...
       async editData(data){
            const inputValue = data.nama_jabfung;
            const { value: name } = await this.$swal({
            ...
            if (name) {
                await this.axios.post(`/api/datajabfung/${data.id}`, { nama_jabfung: name,_method:'patch' }).then(response => {
                    this.$swal({
                        position: "top-end",
                        icon: "success",
                        title: "Your work has been delete",
